        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmallPrice = table.Column<float>(nullable: false),
                    MediumPrice = table.Column<float>(nullable: false),
                    LargePrice = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PizzaIngredient_Pizzas_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Pizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PizzaIngredient_Ingredients_PizzaId",
                        column: x => x.PizzaId,
